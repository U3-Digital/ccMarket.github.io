...
const Menu = () => {
    ...
    return(
        <>
          ...
          <div className="logo-wrapper"><a href="index.html"><img className="img-fluid for-light" src="../backend/assets/images/logo/logo.png" alt=""/><img className="img-fluid for-dark" src="../backend/assets/images/logo/logo_dark.png" alt=""/></a>
          ...
          <div className="logo-icon-wrapper"><a href="index.html"><img className="img-fluid" src="../backend/assets/images/logo/logo-icon.png" alt=""/></a></div>
          <nav>
            <div className="main-navbar">
              <div className="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
              <div id="mainnav">
                <ul className="nav-menu custom-scrollbar">
                  <li className="back-btn"><a href="index.html"><img className="img-fluid" src="../backend/assets/images/logo/logo-icon.png" alt=""/></a>
                  ...
                  <li className="sidebar-title">
                    <div>
                      ...
                      <p className="lan-2">Hola.</p>
                    </div>
                  </li>
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="home"></i><span className="lan-3">Dashboard</span>
                  ...
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="airplay"></i><span className="lan-6">Widgets</span></a>
                    <ul className="nav-submenu menu-content">
                      <li><a href="general-widget.html">General</a></li>
                      <li><a href="chart-widget.html">Chart</a></li>
                    </ul>
                  </li>
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="layout"></i><span className="lan-7">Page layout</span></a>
                    <ul className="nav-submenu menu-content">
                  ...
                  <li className="sidebar-title">
                    <div>
                      ...
                      <p className="lan-9">Ready to use Apps</p>
                    </div>
                  </li>
                  ...
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="mail"></i><span>Email</span></a>
                    <ul className="nav-submenu menu-content">
                      <li><a href="email-application.html">Email App</a></li>
                      <li><a href="email-compose.html">Email Compose</a></li>
                    </ul>
                  </li>
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="message-circle"></i><span>Chat</span></a>
                    <ul className="nav-submenu menu-content">
                      <li><a href="chat.html">Chat App</a></li>
                      <li><a href="chat-video.html">Video chat</a></li>
                    </ul>
                  </li>
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="users"></i><span>Users</span></a>
                    <ul className="nav-submenu menu-content">
                  ...
                  <li className="dropdown"><a className="nav-link menu-title link-nav" href="bookmark.html"><i data-feather="heart"> </i><span>Bookmarks</span></a></li>
                  <li className="dropdown"><a className="nav-link menu-title link-nav" href="contacts.html"><i data-feather="list"> </i><span>Contacts</span></a></li>
                  <li className="dropdown"><a className="nav-link menu-title link-nav" href="task.html"><i data-feather="check-square"> </i><span>Tasks</span></a></li>
                  <li className="dropdown"><a className="nav-link menu-title link-nav" href="calendar-basic.html"><i data-feather="calendar"> </i><span>Calendar</span></a></li>
                  <li className="dropdown"><a className="nav-link menu-title link-nav" href="social-app.html"><i data-feather="zap"> </i><span>Social App</span></a></li>
                  <li className="dropdown"><a className="nav-link menu-title link-nav" href="to-do.html"><i data-feather="clock"> </i><span>To-Do</span></a></li>
                  <li className="sidebar-title">
                    <div>
                      <h6>Components</h6>
                  ...
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="box"></i><span>Ui Kits</span></a>
                    <ul className="nav-submenu menu-content">
                      ...
                      <li><a className="submenu-title" href="#">Tabs<span className="sub-arrow"><i className="fa fa-angle-right"></i></span></a>
                  ...
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="folder-plus"></i><span>Bonus Ui</span></a>
                    <ul className="nav-submenu menu-content">
                      ...
                      <li><a className="submenu-title" href="#">Timeline<span className="sub-arrow"><i className="fa fa-angle-right"></i></span></a>
                        <ul className="nav-sub-childmenu submenu-content">
                  ...
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="edit-3"></i><span>Builders</span></a>
                    <ul className="nav-submenu menu-content">
                  ...
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="cloud-drizzle"></i><span>Animation</span></a>
                    <ul className="nav-submenu menu-content">
                  ...
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="command"></i><span>Icons</span></a>
                    <ul className="nav-submenu menu-content">
                  ...
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="cloud"></i><span>Buttons</span></a>
                    <ul className="nav-submenu menu-content">
                  ...
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="bar-chart"></i><span>Charts</span></a>
                    <ul className="nav-submenu menu-content">
                  ...
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="file-text"></i><span>Forms</span></a>
                    <ul className="nav-submenu menu-content">
                      <li><a className="submenu-title" href="#">Form Controls<span className="sub-arrow"><i className="fa fa-angle-right"></i></span></a>
                        <ul className="nav-sub-childmenu submenu-content">
                      ...
                      <li><a className="submenu-title" href="#">Form Widgets<span className="sub-arrow"><i className="fa fa-angle-right"></i></span></a>
                        <ul className="nav-sub-childmenu submenu-content">
                      ...
                      <li><a className="submenu-title" href="#">Form layout<span className="sub-arrow"><i className="fa fa-angle-right"></i></span></a>
                        <ul className="nav-sub-childmenu submenu-content">
                  ...
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="server"></i><span>Tables</span></a>
                    <ul className="nav-submenu menu-content">
                      ...
                      <li><a className="submenu-title" href="#">Ex. Data Tables<span className="sub-arrow"><i className="fa fa-angle-right"></i></span></a>
                        <ul className="nav-sub-childmenu submenu-content">
                  ...
                  <li className="dropdown"><a className="nav-link menu-title link-nav" href="landing-page.html"><i data-feather="cast"> </i><span>Landing page</span></a></li>
                  <li className="dropdown"><a className="nav-link menu-title link-nav" href="sample-page.html"><i data-feather="file-text"> </i><span>Sample page</span></a></li>
                  <li className="dropdown"><a className="nav-link menu-title link-nav" href="internationalization.html"><i data-feather="globe"> </i><span>Internationalization</span></a></li>
                  <li className="dropdown"><a className="nav-link menu-title link-nav" href="../starter-kit/index.html" target="_blank"><i data-feather="anchor"></i><span>Starter kit</span></a></li>
                  <li className="mega-menu"><a className="nav-link menu-title" href="#"><i data-feather="layers"></i><span>Others</span></a>
                  ...
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="image"></i><span>Gallery</span></a>
                    <ul className="nav-submenu menu-content">
                  ...
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="film"></i><span>Blog</span></a>
                    <ul className="nav-submenu menu-content">
                  ...
                  <li className="dropdown"><a className="nav-link menu-title link-nav" href="faq.html"><i data-feather="help-circle"> </i><span>FAQ</span></a></li>
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="package"></i><span>Job Search</span></a>
                    <ul className="nav-submenu menu-content">
                  ...
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="radio"></i><span>Learning</span></a>
                    <ul className="nav-submenu menu-content">
                      <li><a href="learning-list-view.html">Learning List</a></li>
                      <li><a href="learning-detailed.html">Detailed Course</a></li>
                    </ul>
                  </li>
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="map"></i><span>Maps</span></a>
                    <ul className="nav-submenu menu-content">
                  ...
                  <li className="dropdown"><a className="nav-link menu-title" href="#"><i data-feather="edit"></i><span>Editors</span></a>
                    <ul className="nav-submenu menu-content">
                  ...
                  <li className="dropdown"><a className="nav-link menu-title link-nav" href="knowledgebase.html"><i data-feather="sunrise"> </i><span>Knowledgebase</span></a></li>
                  <li className="dropdown"><a className="nav-link menu-title link-nav" href="support-ticket.html"><i data-feather="users"> </i><span>Support Ticket</span></a></li>
                </ul>
              </div>
