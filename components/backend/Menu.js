    ...
    return (
        <>
            <header className="main-nav">
                <div className="logo-wrapper"><a href="dashboard"><img className="img-fluid for-light" src="../backend/assets/images/logo/logo.png" alt="" /><img className="img-fluid for-dark" src="../backend/assets/images/logo/logo_dark.png" alt="" /></a>
