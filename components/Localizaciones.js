      ...
      <div className="container">
        ...
        <div className="row">
              ...
              <div className="col-sm-12 col-lg-6 col-md-6 ">
                <div className="item-card overflow-hidden">
                  <div className="item-card-desc">
                    <div className="card text-center overflow-hidden" style={{ height: '18em' }}>
                      <div className="card-img">
                        <img src="../img/locations/creelChihuahua.jpg" style={{ height: '100%' }} alt="img" className="cover-image" />
                      </div>
              ...
              <div className="col-sm-12 col-lg-6 col-md-6 ">
                <div className="item-card overflow-hidden">
                  <div className="item-card-desc">
                    <div className="card text-center overflow-hidden" style={{ height: '18em' }}>
                      <div className="card-img">
                        <img src="../img/locations/laJuntaChihuahua.jpg" style={{ height: '100%' }} alt="img" className="cover-image" />
                      </div>
                      <div className="item-card-text">
              ...
              <div className="col-sm-12 col-lg-6 col-md-6 ">
                <div className="item-card overflow-hidden">
                  <div className="item-card-desc">
                    <div className="card text-center overflow-hidden" style={{ height: '18em' }}>
                      <div className="card-img">
                        <img src="../img/locations/anahuacChihuahua.jpg" style={{ height: '100%' }} alt="img" className="cover-image" />
                      </div>
                      <div className="item-card-text">
                        <h4 className="mb-0">{anahuac} Negocios<span><i className="fa fa-map-marker text-primary mr-1"></i>Anáhuac</span></h4>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-sm-12 col-lg-6 col-md-6 ">
                <div className="item-card overflow-hidden">
                  <div className="item-card-desc">
                    <div className="card text-center overflow-hidden" style={{ height: '18em' }}>
                      <div className="card-img">
                        <img src="../img/locations/guerreroChihuahua.jpg" style={{ height: '100%' }} alt="img" className="cover-image" />
                      </div>
                      <div className="item-card-text">
          ...
          <div className="col-lg-12 col-md-12 col-xl-6 col-sm-12">
            <div className="item-card overflow-hidden">
              <div className="item-card-desc">
                <div className="card overflow-hidden" style={{ height: '37.5em' }}>
                  <div className="card-img">
                    <img src="../img/locations/monumentoacuauhtemoc.jpg" style={{ height: '100%' }} alt="img" className="cover-image" />
                  </div>
                  <div className="item-card-text">
