...
import Navs from '../components/ui-kits/nav'
...
import Steps from '../components/bonus_ui/steps'
...
import Timeline2 from '../components/bonus_ui/timelines/timeline2'
...
export const routes = [
        ...
        { path:"/bonus-ui/timelines/timeline2", Component:Timeline2},
        ...
        { path:"/app/map/LeafletMap", Component:LeafletMap},

        { path:"/app/editor/ckEditor", Component:CkEditor},
        { path:"/app/editor/mdeEditor", Component:MdeEditor},
        { path:"/app/editor/acecodeEditor", Component:AceCodeEditor},
